...
_UNIVERSE_KR: list[str] = [
    ...
    # 조선 추가
    "082740.KS",  # HSD엔진
    # 방산 추가 — US 방산주와 양방향 연동
    "272210.KS",  # 한화시스템
    "047810.KS",  # 한국항공우주(KAI)
    "103140.KS",  # 풍산
    # AI 전력기기 / 전선 — US 전력주와 연동
    "267260.KS", "229640.KS",
    ...
    "138040.KS",  # 메리츠금융지주
    # 통신
    "017670.KS", "030200.KS", "032640.KS",  # LG유플러스
]
...
_NAME_MAP: dict[str, str] = {
    ...
    "GD": "General Dynamics", "HII": "Huntington Ingalls", "BA": "Boeing",
    "LHX": "L3Harris", "LDOS": "Leidos", "KTOS": "Kratos Defense", "HEI": "HEICO",
    # 반도체장비 추가
    "MCHP": "Microchip Technology", "MPWR": "Monolithic Power",
    "ACLS": "Axcelis Technologies", "ONTO": "Onto Innovation",
    # 사이버보안
    "CRWD": "CrowdStrike", "PANW": "Palo Alto Networks", "NET": "Cloudflare",
    "DDOG": "Datadog", "ZS": "Zscaler", "FTNT": "Fortinet",
    # AI 전력 추가
    "AES": "AES Corp", "NRG": "NRG Energy", "SO": "Southern Company",
    "HUBB": "Hubbell", "BW": "Babcock & Wilcox",
    # 금융/핀테크
    "JPM": "JPMorgan", "GS": "Goldman Sachs", "MS": "Morgan Stanley",
    "BAC": "Bank of America", "V": "Visa", "MA": "Mastercard",
    "PYPL": "PayPal", "C": "Citigroup",
    # 에너지
    ...
    "PFE": "Pfizer", "GILD": "Gilead Sciences", "BMY": "Bristol-Myers",
    "AMGN": "Amgen", "JNJ": "Johnson & Johnson",
    # 소비재/리테일
    "ELF": "e.l.f. Beauty", "ULTA": "Ulta Beauty", "NKE": "Nike", "SBUX": "Starbucks",
    # 크립토
    "COIN": "Coinbase",
    # KR 반도체/전자
    "005930.KS": "삼성전자", "000660.KS": "SK하이닉스", "066570.KS": "LG전자",
    # KR 반도체 소부장
    "042700.KS": "한미반도체", "039030.KS": "이오테크닉스", "240810.KS": "원익IPS",
    "058470.KS": "리노공업", "166090.KS": "하나머티리얼즈", "357780.KS": "솔브레인",
    # KR IT
    "035420.KS": "NAVER", "035720.KS": "카카오",
    # KR 배터리/소재
    "051910.KS": "LG화학", "006400.KS": "삼성SDI",
    "373220.KS": "LG에너지솔루션", "003670.KS": "포스코퓨처엠",
    "247540.KS": "에코프로비엠", "066970.KS": "엘앤에프", "005490.KS": "POSCO홀딩스",
    # KR 자동차
    ...
    "010620.KS": "현대미포조선", "082740.KS": "HSD엔진",
    "272210.KS": "한화시스템", "047810.KS": "한국항공우주", "103140.KS": "풍산",
    # KR AI 전력기기 / 전선
    "267260.KS": "HD현대일렉트릭", "229640.KS": "LS에코에너지",
    "010120.KS": "LS ELECTRIC", "006260.KS": "LS",
    "103590.KQ": "일진전기", "033100.KQ": "제룡전기", "298040.KS": "효성중공업",
    # KR AI 인프라 PCB
    "007660.KS": "이수페타시스",
    # KR K뷰티
    "161890.KQ": "한국콜마", "090430.KS": "아모레퍼시픽",
    "192820.KQ": "코스맥스", "051900.KS": "LG생활건강", "237880.KQ": "클리오",
    # KR 에너지/화학/지주
    "096770.KS": "SK이노베이션", "034730.KS": "SK", "078930.KS": "GS",
    # KR 금융
    "086790.KS": "하나금융지주", "105560.KS": "KB금융",
    "055550.KS": "신한지주", "138040.KS": "메리츠금융지주",
    # KR 통신
...
_SECTOR_MAP: dict[str, str] = {
    ...
    "GD": "방산/항공", "HII": "방산/조선", "BA": "항공/방산",
    "LHX": "방산전자", "LDOS": "방산IT", "KTOS": "방산드론", "HEI": "항공부품",
    # 반도체장비 추가
    "MCHP": "반도체", "MPWR": "반도체전력IC", "ACLS": "반도체장비", "ONTO": "반도체장비",
    # 사이버보안
    "CRWD": "사이버보안", "PANW": "사이버보안", "NET": "클라우드보안",
    "DDOG": "클라우드모니터링", "ZS": "사이버보안", "FTNT": "사이버보안",
    # AI 전력 추가
    "AES": "전력/유틸리티", "NRG": "전력/유틸리티", "SO": "전력/유틸리티",
    "HUBB": "AI전력기기", "BW": "발전설비",
    # 금융/핀테크
    "JPM": "금융", "GS": "금융", "MS": "금융", "BAC": "금융",
    "V": "결제/핀테크", "MA": "결제/핀테크", "PYPL": "결제/핀테크", "C": "금융",
    # 에너지
    "XOM": "에너지", "CVX": "에너지", "COP": "에너지", "SLB": "유전서비스",
    # 바이오/헬스케어
    "LLY": "바이오/제약", "UNH": "헬스케어", "MRNA": "바이오/제약",
    "ABBV": "바이오/제약", "REGN": "바이오/제약",
    "PFE": "바이오/제약", "GILD": "바이오/제약", "BMY": "바이오/제약",
    "AMGN": "바이오/제약", "JNJ": "헬스케어",
    # 소비재/리테일
    "ELF": "K뷰티/뷰티", "ULTA": "뷰티리테일", "NKE": "스포츠/소비재", "SBUX": "외식/소비재",
    # 크립토
    "COIN": "크립토/핀테크",
    # KR 반도체/전자
    "005930.KS": "반도체/전자", "000660.KS": "반도체", "066570.KS": "전자",
    # KR 반도체 소부장
    "042700.KS": "반도체장비", "039030.KS": "반도체장비", "240810.KS": "반도체장비",
    "058470.KS": "반도체소재", "166090.KS": "반도체소재", "357780.KS": "반도체소재",
    # KR IT
    "035420.KS": "IT서비스", "035720.KS": "IT서비스",
    # KR 배터리/소재
    "051910.KS": "화학/배터리", "006400.KS": "배터리",
    "373220.KS": "배터리", "003670.KS": "배터리소재",
    "247540.KS": "배터리소재", "066970.KS": "배터리소재", "005490.KS": "철강/소재",
    # KR 자동차
    "005380.KS": "자동차", "000270.KS": "자동차", "012330.KS": "자동차부품",
    # KR 바이오
    "207940.KS": "바이오/CDMO", "068270.KS": "바이오", "000100.KS": "바이오/제약",
    "128940.KS": "바이오/제약", "185750.KS": "바이오/제약",
    # KR 조선/방산
    "329180.KS": "조선/방산", "010140.KS": "조선", "042660.KS": "조선/방산",
    "012450.KS": "방산/항공우주", "064350.KS": "방산/전차", "079550.KS": "방산/미사일",
    "010620.KS": "조선", "082740.KS": "조선엔진",
    "272210.KS": "방산전자", "047810.KS": "항공우주", "103140.KS": "방산/동",
    # KR AI 전력기기 / 전선 / PCB
    "267260.KS": "AI전력기기", "229640.KS": "전선/케이블", "007660.KS": "AI인프라PCB",
    "010120.KS": "AI전력기기", "006260.KS": "전기/지주",
    "103590.KQ": "AI전력기기", "033100.KQ": "변압기", "298040.KS": "AI전력기기",
    # KR K뷰티
    "161890.KQ": "K뷰티ODM", "090430.KS": "K뷰티브랜드",
    "192820.KQ": "K뷰티ODM", "051900.KS": "K뷰티브랜드", "237880.KQ": "K뷰티브랜드",
    # KR 에너지/화학/지주
    "096770.KS": "에너지/화학", "034730.KS": "지주/에너지", "078930.KS": "에너지/유통",
    # KR 금융
    "086790.KS": "금융", "105560.KS": "금융", "055550.KS": "금융", "138040.KS": "금융",
    # KR 통신
